...
class UpdatePass extends JFrame implements ActionListener {
    ...
    static private JTextField txtoldpass;
    ...
    static private JTextField tpass;
      ...
      private Socket s2;
      public String ind;
    public UpdatePass(Socket s,String index)
    {
        this.s2=s;
        ind=index;
        ...
        title = new JLabel("Update Password Form");
       ...
       c.add(oldpass);
        ...
        txtoldpass.setSize(190, 20);
        txtoldpass.setLocation(200, 150);
        c.add(txtoldpass);
